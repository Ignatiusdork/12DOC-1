...
async function main() {
  ...
  const santasContract = await ethers.deployContract("SantasGreetings");
  // 10 is the Maximum number of whitelisted addresses allowed

  // wait for the contract to deploy of the whitelis contract
  await santasContract.waitForDeployment();

  // print the address of the deployed contract
  console.log("SantasGreetings Contract Address:", santasContract.target);
